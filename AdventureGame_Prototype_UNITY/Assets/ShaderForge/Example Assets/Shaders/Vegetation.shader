...
/////// Diffuse:
                ...
                float node_331 = 1.0;
                float3 diffuseColor = (lerp(float3(node_331,node_331,node_331),float3(0.9779412,0.7890974,0),i.vertexColor.b)*_Diffuse_var.rgb);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float node_331 = 1.0;
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(i.uv0, _Diffuse));
                float3 diffColor = (lerp(float3(node_331,node_331,node_331),float3(0.9779412,0.7890974,0),i.vertexColor.b)*_Diffuse_var.rgb);
                float node_3 = 0.2;
